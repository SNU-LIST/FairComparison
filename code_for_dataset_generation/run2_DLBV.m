%% train2
clear all
load('train2/phscos.mat','multiphs','multicos');
load('../Dbkg/train2/multimask.mat');
...
%% train3
clear all
load('train3/phscos.mat','multiphs','multicos');
load('../Dbkg/train3/multimask.mat');
...
load('train4/phscos.mat','multiphs','multicos');
load('../Dbkg/train4/multimask.mat');
...
load('train5/phscos.mat','multiphs','multicos');
load('../Dbkg/train5/multimask.mat');
...
load('train6/phscos.mat','multiphs','multicos');
load('../Dbkg/train6/multimask.mat');
...
load('train7/phscos.mat','multiphs','multicos');
load('../Dbkg/train7/multimask.mat');
...
load('test1/phscos.mat','multiphs','multicos');
load('../Dbkg/test1/multimask.mat');
...
load('test2/phscos.mat','multiphs','multicos');
load('../Dbkg/test2/multimask.mat');
...
load('test3/phscos.mat','multiphs','multicos');
load('../Dbkg/test3/multimask.mat');
...
load('test4/phscos.mat','multiphs','multicos');
load('../Dbkg/test4/multimask.mat');
...
load('test5/phscos.mat','multiphs','multicos');
load('../Dbkg/test5/multimask.mat');
